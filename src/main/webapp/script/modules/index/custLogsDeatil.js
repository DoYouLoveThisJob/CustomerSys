...
function setShowPage(logId){
	$.ajax({
		url: "logs/getCustLogs",
		type:"post",
		data: {
			logId:logId
		},
		...
		success: function(data){
			if(data!=undefined && data!=null){
				...
				$("#appType").val(obj.appTypeDesc+"("+obj.appVersion+")");
				$("#behavior").val(obj.behaviorDesc);
				$("#behaviorContent").val(obj.behaviorContent);
				$("#browser").val(obj.browserDesc+"("+obj.browserVersion+")");
				$("#device").val(obj.device);
				$("#ipAddress").val(obj.ipAddress);
				$("#optSystem").val(obj.optSystemDesc+"("+obj.appVersion+")");
			}
		}
	});
}
