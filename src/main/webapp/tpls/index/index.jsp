...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <div class="span12">
                    <div class="span12">
                        <div class="span3"> <input type="text" class="form-control pull-left" id="searchText" placeholder="根据用户编码查询" ></div>
                        ...
                        <div class="span3"> <a href="javascript:void(0);" class="btn btn-primary" id="queryBtn">查询</a></div>
                    </div>
                    <div class="span11">
