...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <%--<span style="color:red;" class="form-control">注：填写触发器名，需要在spring配置好该定时作业的触发器(trigger)和工作细节(jobDeatil)</span>--%>
            <%--<span style="color:red;" class="form-control">注：建议使用英文</span>--%>
            <%--<span style="color:red;" class="form-control">注：定时作业中需要调用的controller类的class值，包含包名和类名，具体是在controller类调用不需要依赖注入的方法时候，填写该class值。</span>--%>
            <%--<span style="color:red;" class="form-control">注：定时作业中需要调用的controller类的spring配置文件的中bean的id值，如果执行方方法调用存在依赖注入关系时，必须填写</span>--%>
            <%--<span style="color:red;" class="form-control">注：定时作业中需要调用的controller类中需要执行的方法名</span>--%>

                <div class="span12"  id="jobStatusDiv">
                    <span class="form-control">作业状态:</span>
                ...
                <%--<div class="span12">--%>
                    <%--<span class="form-control">是否需要中断:</span>--%>
                    <%--<select class="form-control" id="isInterrupt">--%>
                        <%--<option value="1">需要</option>--%>
                        <%--<option value="0">不需要</option>--%>
                    <%--</select>--%>
                <%--</div>--%>
                <div class="span12">
                    <span class="form-control">作业规则:</span>
                    <div class="span12">
                    ...
                    <div class="span12">
                        <input type="radio" name="cronExpressionMethod" value="cronExpression">按定时规则执行:
                        <input type="text" class="form-control"  placeholder="cronExpression"   id="cronExpression"/>
                    </div>
                </div>
                <div class="span12">
                    <span class="form-control">作业内容:</span>
                    <div class="span12">
...
<script src="script/modules/task/addTask.js"></script>
<%--<footer>--%>
    <%--<p>--%>
